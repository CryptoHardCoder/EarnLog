...
//import Charts
//
//private let allItems = AppFileManager.shared.allItems
//var items = AppFileManager.shared.getDailyTotal(items: allItems )
//
//struct CircleChart: View {
//    var items = AppFileManager.shared.getDailyTotal(items: allItems )
//    var filteredItems = AppFileManager.shared.getDailyTotal(items: items)
//    var body: some View {
//        ZStack { 
//            VStack{
...
//                                SectorMark(angle: .value(item.date, item.totalPrice))
//                            }
//                        }
//                    }
//                }
