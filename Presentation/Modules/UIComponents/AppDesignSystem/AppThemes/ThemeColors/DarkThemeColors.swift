...
struct DarkThemeColors: ThemeColorsProtocol {

    let primary: UIColor = BaseColors.green500

    let primaryVariant: UIColor = BaseColors.green400

    let background: UIColor = BaseColors.black900

    let backgroundSecondary: UIColor = BaseColors.black400

    let textPrimary: UIColor = BaseColors.white50

    let textSecondary: UIColor = BaseColors.white200

    let textTertiary: UIColor = BaseColors.white400

    let textQuaternary: UIColor = BaseColors.white500
    ...
    let itemCellsBackground: UIColor = BaseColors.black500

    let shadowColor: UIColor = BaseColors.white50

    let card: CardColors = CardColors(
        backgroundGradient: [
            UIColor(hex: "#0F673A").cgColor,
    ...
    let monthlyGoal: MonthlyGoalColors = MonthlyGoalColors(
        background: BaseColors.green900,
    ...
    let alert: AlertColors = AlertColors(
        background: BaseColors.black400,
